...
export interface GalaxyProps {
  ...
  readonly hasMouseInteraction?: boolean;
  readonly glowIntensity?: number;
  readonly saturation?: number;
  readonly hasMouseRepulsion?: boolean;
  readonly twinkleIntensity?: number;
  readonly rotationSpeed?: number;
  readonly repulsionStrength?: number;
  readonly autoCenterRepulsion?: number;
  readonly isTransparent?: boolean;
  readonly mixBlendMode?: React.CSSProperties[`mixBlendMode`] | `none`;
}
...
export const Galaxy: React.FC<GalaxyProps> = ({
  ...
  density = 1,
  hueShift = 140,
  isAnimationDisabled: disableAnimation = false,
  speed = 1.0,
  hasMouseInteraction: mouseInteraction = true,
  glowIntensity = 0.3,
  saturation = 0.0,
  hasMouseRepulsion: mouseRepulsion = true,
  repulsionStrength = 2,
  ...
  return <div ref={ctnDom} className={styles.frame} {...rest} />;
};
